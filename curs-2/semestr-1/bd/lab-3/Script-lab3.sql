...
INSERT INTO Students (student_id, full_name, age, email, phone_number)
VALUES 
(5, 'Charlie Green', 20, 'charliegreen@example.com', '567-890-1234'),
(6, 'Diana White', 22, 'dianawhite@example.com', '678-901-2345'),
(7, 'Ethan Black', 19, 'ethanblack@example.com', '789-012-3456'),
(8, 'Fiona Blue', 21, 'fionablue@example.com', '890-123-4567');
